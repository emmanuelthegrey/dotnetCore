...
namespace MvcMelange.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MelangePurchaseApiController : ControllerBase
    {
        private readonly MvcMelangePurchaseContext _context;

        public MelangePurchaseApiController(MvcMelangePurchaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<MelangePurchase>> PostMelangePurchase(MelangePurchase melangePurchase)
        {
            ...
            return CreatedAtAction(nameof(GetMelangePurchase), new { id = melangePurchase.Id }, melangePurchase);
        }
